...
import { initDrag, wireRowDrag } from '/js/admin-drag.js?v=0dee198d';
import { paintIcon } from '/js/admin-shared.js?v=ee1d30d8';
import { clr as rc, el, qa, setUserText } from '/js/utils.js?v=ec5ae295';
import { html, raw, setHtml } from '/js/html.js?v=c71f8903';
import { t } from '/js/i18n.js?v=1f1ea9c1';
import { sizeLabel } from '/js/admin-widget-form.js?v=93ca6dec';
