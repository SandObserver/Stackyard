...
import { reveal, wireInlineEdit } from '/js/admin-shared.js?v=48a588fa';
import { createListbox } from '/js/listbox.js?v=efea51f2';
import { renderColorControl } from '/js/admin-color-control.js?v=cc549ffa';
import {
  seedCarried,
  applyOptionSet,
  collectFieldValues,
  ...
  groupBounds,
  visibleFieldFlags,
} from '/js/admin-logic.js?v=85ba3690';
