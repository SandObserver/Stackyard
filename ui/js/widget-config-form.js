...
import { reveal, wireInlineEdit } from '/js/admin-shared.js?v=ee1d30d8';
import { createListbox } from '/js/listbox.js?v=bec7bc4b';
import { renderColorControl } from '/js/admin-color-control.js?v=eda30087';
import {
  seedCarried,
  applyOptionSet,
  collectFieldValues,
...
import { qi } from '/js/utils.js?v=ec5ae295';
