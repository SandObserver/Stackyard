...
import { wireChecklist } from '/js/admin-shared.js?v=6ca8f3dd';
import { renderColorControl } from '/js/admin-color-control.js?v=ff330e63';
import {
  seedCarried,
  applyOptionSet,
  collectFieldValues,
...
import { qi } from '/js/utils.js?v=b9a5b134';
