...
import { wireChecklist } from '/js/admin-shared.js?v=c2c4a4a5';
import { renderColorControl } from '/js/admin-color-control.js?v=d296b27d';
import {
  seedCarried,
  applyOptionSet,
  collectFieldValues,
...
import { qi } from '/js/utils.js?v=8a2001ad';
