...
import { wireChecklist } from '/js/admin-shared.js?v=78a4fff2';
import { renderColorControl } from '/js/admin-color-control.js?v=4fa61c6b';
import {
  seedCarried,
  applyOptionSet,
  collectFieldValues,
...
import { qi } from '/js/utils.js?v=d7db702a';
