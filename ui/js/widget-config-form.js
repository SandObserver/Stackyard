...
import { wireChecklist } from '/js/admin-shared.js?v=cd2162b7';
import { renderColorControl } from '/js/admin-color-control.js?v=234b76f0';
import {
  seedCarried,
  applyOptionSet,
  collectFieldValues,
...
import { qi } from '/js/utils.js?v=3ae4d9d8';
