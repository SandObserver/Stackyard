...
import { wireChecklist } from '/js/admin-shared.js?v=767a14c1';
import { renderColorControl } from '/js/admin-color-control.js?v=6d975f24';
import {
  seedCarried,
  applyOptionSet,
  collectFieldValues,
...
import { qi } from '/js/utils.js?v=bc2329e9';
