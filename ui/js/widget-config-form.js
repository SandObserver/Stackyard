...
import { wireChecklist } from '/js/admin-shared.js?v=b166ff5e';
import { renderColorControl } from '/js/admin-color-control.js?v=47ea14a9';
import {
  seedCarried,
  applyOptionSet,
  collectFieldValues,
...
import { qi } from '/js/utils.js?v=0cfffdfb';
