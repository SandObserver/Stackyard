...
import { reveal, wireInlineEdit } from '/js/admin-shared.js?v=68fb1cb2';
import { createListbox } from '/js/listbox.js?v=93ffd65a';
import { renderColorControl } from '/js/admin-color-control.js?v=edadf6bb';
import {
  seedCarried,
  applyOptionSet,
  collectFieldValues,
...
import { qi } from '/js/utils.js?v=18f28539';
