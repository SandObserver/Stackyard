...
import {
  ...
  teardownWidgets,
  titleWhenTruncated,
} from '/js/utils.js?v=7d0a2f7d';
import { initFluidHover } from '/js/fluid-hover.js?v=cb886e86';
import { initSpotlight } from '/js/spotlight.js?v=a6f5775a';
...
import { applyBackground, BACKDROP, resolveBackground } from '/js/background.js?v=92d3f3c2';
