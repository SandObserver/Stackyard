...
import { initSpotlight } from '/js/spotlight.js?v=3d038c35';
...
import { applyBackground, BACKDROP, resolveBackground } from '/js/background.js?v=09beead7';
