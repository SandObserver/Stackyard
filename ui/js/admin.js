import { buildAppForm, buildFolderForm, captureActLabels, serializeKvRows } from '/js/admin-app-form.js?v=8a42d8e0';
import { checkAuth, requireLogin, wirePasswordStrength } from '/js/admin-auth.js?v=a73706fe';
import { initList, render, syncFilterUI } from '/js/admin-list.js?v=e00006a8';
...
import { loadSettings, settingsDirty, showBgFields, showWallpaperFile } from '/js/admin-settings.js?v=f87eb909';
import {
  apiGet,
  apiPost,
  initInlineEdit,
  ...
  setReauthHandler,
  toast,
} from '/js/admin-shared.js?v=e477e574';
import { collapsedFolders, filter, state } from '/js/admin-state.js?v=831e219e';
import { buildWidgetForm } from '/js/admin-widget-form.js?v=bb851134';
...
import { el, inp, q, qa, clr, setUserText, tgt } from '/js/utils.js?v=01662438';
import { applyBackground, resolveBackground } from '/js/background.js?v=09beead7';
