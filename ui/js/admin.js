import { buildAppForm, buildFolderForm, captureActLabels, serializeKvRows } from '/js/admin-app-form.js?v=40e092d6';
import { checkAuth, requireLogin, wirePasswordStrength } from '/js/admin-auth.js?v=99bc01b6';
import { initList, render, syncFilterUI } from '/js/admin-list.js?v=b2726a47';
import { resolveAdminSection } from '/js/admin-logic.js?v=85ba3690';
import {
  buildAppItem,
  claimFolderChildren,
  newItemId,
...
import { loadSettings, settingsDirty, showBgFields, showWallpaperFile } from '/js/admin-settings.js?v=0c872568';
import { ag, ap, initInlineEdit, paintIcon, reveal, setReauthHandler, toast } from '/js/admin-shared.js?v=48a588fa';
import { collapsedFolders, filter, state } from '/js/admin-state.js?v=5a5d655f';
import { buildWidgetForm } from '/js/admin-widget-form.js?v=456cb43d';
...
import { normalizeColorInput } from '/js/admin-color-control.js?v=cc549ffa';
