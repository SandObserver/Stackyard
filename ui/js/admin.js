import { buildAppForm, buildFolderForm, captureActLabels, serializeKvRows } from '/js/admin-app-form.js?v=346878ed';
import { checkAuth, requireLogin, wirePasswordStrength } from '/js/admin-auth.js?v=4509deb0';
...
import { loadSettings, showBgFields, showBgFit, showWallpaperFile } from '/js/admin-settings.js?v=a06856d7';
import { ag, ap, initInlineEdit, setReauthHandler, toast } from '/js/admin-shared.js?v=b166ff5e';
import { state } from '/js/admin-state.js?v=c23e6346';
import { buildWidgetForm } from '/js/admin-widget-form.js?v=4a48ba40';
...
import { el, inp, q, qa, clr as rc, sanitizeCssUrl, setUserText, tgt } from '/js/utils.js?v=0cfffdfb';
import { normalizeColorInput } from '/js/admin-color-control.js?v=47ea14a9';
