import { buildAppForm, buildFolderForm, captureActLabels, serializeKvRows } from '/js/admin-app-form.js?v=0239e02d';
import { checkAuth, requireLogin, wirePasswordStrength } from '/js/admin-auth.js?v=66367bea';
import { initList, render, syncFilterUI } from '/js/admin-list.js?v=1e0239cd';
...
import { loadSettings, settingsDirty, showBgFields, showWallpaperFile } from '/js/admin-settings.js?v=c469142d';
import { ag, ap, initInlineEdit, paintIcon, reveal, setReauthHandler, toast } from '/js/admin-shared.js?v=c916f839';
import { collapsedFolders, filter, state } from '/js/admin-state.js?v=5a5d655f';
import { buildWidgetForm } from '/js/admin-widget-form.js?v=6db90f13';
import { initFluidHover } from '/js/fluid-hover.js?v=cb886e86';
import { initGlideSelect, syncGlideSelect } from '/js/glide-select.js?v=8b39e9d0';
import { createListbox } from '/js/listbox.js?v=6ed1bfda';
...
import { normalizeColorInput } from '/js/admin-color-control.js?v=b7770401';
