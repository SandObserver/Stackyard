import { clr as rc, el, inp as inpById, q as qSel, qa, qi, tgt } from '/js/utils.js?v=3eb63c9e';
...
import {
  ...
  setTogDisabled,
  wireChecklist,
} from '/js/admin-shared.js?v=abaed3c3';
import { MAX_LABELS } from '/js/badge-logic.js?v=be6330d6';
import { renderColorControl, BADGE_SWATCHES, BADGE_DEFAULT } from '/js/admin-color-control.js?v=99d74820';
