import { clr, el, inp as inpById, q as qSel, qa, qi, tgt } from '/js/utils.js?v=01662438';
...
import { renderColorControl, BADGE_DEFAULT } from '/js/admin-color-control.js?v=ee39fb36';
