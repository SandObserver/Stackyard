...
import { isDockBlocked, DOCK_MAX, clearsStoredSecret } from '/js/admin-logic.js?v=8558624f';
...
import {
  ...
  setTogDisabled,
  wireChecklist,
} from '/js/admin-shared.js?v=7669ed7d';
import { renderColorControl, BADGE_SWATCHES } from '/js/admin-color-control.js?v=4c3b8c98';
