...
import { PE_SVG, CHEV_SVG, initInlineEdit } from '/js/admin-shared.js?v=578a9485';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=64989da4';
...
import { q, qi, qa } from '/js/utils.js?v=1e7c27bc';
