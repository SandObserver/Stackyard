...
import { PE_SVG, CHEV_SVG, initInlineEdit } from '/js/admin-shared.js?v=465f9207';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=7fcdfaf1';
import { html, raw, setHtml } from '/js/html.js?v=c71f8903';
import { sizesForView, widgetConfigMode, rejectionLines, carriesTypedValues } from '/js/admin-logic.js?v=0aebc197';
import { t } from '/js/i18n.js?v=e644a5c5';
import { q, qi, qa } from '/js/utils.js?v=d949e985';
