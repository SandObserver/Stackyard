...
import { PE_SVG, CHEV_SVG, initInlineEdit } from '/js/admin-shared.js?v=6ca8f3dd';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=0d82ab23';
...
import { q, qi, qa } from '/js/utils.js?v=b9a5b134';
