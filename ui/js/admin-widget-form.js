...
import { PE_SVG, CHEV_SVG, initInlineEdit } from '/js/admin-shared.js?v=b166ff5e';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=3fd66713';
...
import { q, qi, qa } from '/js/utils.js?v=0cfffdfb';
