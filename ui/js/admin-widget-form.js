...
import { PE_SVG, CHEV_SVG, initInlineEdit } from '/js/admin-shared.js?v=7669ed7d';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=599e76ef';
...
import {
  ...
  refusedNoticeKey,
  carriesTypedValues,
} from '/js/admin-logic.js?v=8558624f';
