...
import { PE_SVG, CHEV_SVG, initInlineEdit } from '/js/admin-shared.js?v=43c167a7';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=c23c047d';
...
import { q, qi, qa } from '/js/utils.js?v=2e617767';
