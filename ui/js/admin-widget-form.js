...
import { PE_SVG, CHEV_SVG, initInlineEdit } from '/js/admin-shared.js?v=a0ccaee8';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=a8dae65a';
...
import { q, qi, qa } from '/js/utils.js?v=3ae4d9d8';
