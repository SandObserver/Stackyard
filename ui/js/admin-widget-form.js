...
import { PE_SVG, initInlineEdit, swapContent } from '/js/admin-shared.js?v=ee1d30d8';
import { createListbox } from '/js/listbox.js?v=bec7bc4b';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=f05cd5a3';
...
import { q, qi, qa } from '/js/utils.js?v=ec5ae295';
