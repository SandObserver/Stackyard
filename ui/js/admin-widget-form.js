...
import { PE_SVG, initInlineEdit, swapContent } from '/js/admin-shared.js?v=68fb1cb2';
import { createListbox } from '/js/listbox.js?v=93ffd65a';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=b397b8f8';
...
import { q, qi, qa } from '/js/utils.js?v=18f28539';
