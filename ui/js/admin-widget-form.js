...
import { PE_SVG, CHEV_SVG, initInlineEdit } from '/js/admin-shared.js?v=767a14c1';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=3ac178e0';
...
import { q, qi, qa } from '/js/utils.js?v=bc2329e9';
