...
import { PE_SVG, initInlineEdit, swapContent } from '/js/admin-shared.js?v=569c6599';
import { createListbox } from '/js/listbox.js?v=f5ccb53e';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=5ff251f6';
...
import { q, qi, qa } from '/js/utils.js?v=db210447';
